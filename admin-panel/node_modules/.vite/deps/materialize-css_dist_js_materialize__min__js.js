...
var require_materialize_min = __commonJS({
  "node_modules/materialize-css/dist/js/materialize.min.js"(exports, module) {
    ...
    !function(t) {
      ...
      return M;
    }) : "undefined" == typeof exports || exports.nodeType || ("undefined" != typeof module && !module.nodeType && module.exports && (exports = module.exports = M), exports.default = M), M.keys = { TAB: 9, ENTER: 13, ESC: 27, ARROW_UP: 38, ARROW_DOWN: 40 }, M.tabPressed = false, M.keyDown = false;
      ...
      var e = { alignment: "left", autoFocus: true, constrainWidth: true, container: null, coverTrigger: true, closeOnClick: true, hover: false, inDuration: 150, outDuration: 250, onOpenStart: null, onOpenEnd: null, onCloseStart: null, onCloseEnd: null, onItemClick: null }, t = function(t2) {
        ...
        return _inherits(n, Component), _createClass(n, [{ key: "destroy", value: function() {
          ...
          if (t3.which === M.keys.TAB) t3.preventDefault(), this.close();
            ...
            do {
              if (s2 += n2, this.dropdownEl.children[s2] && -1 !== this.dropdownEl.children[s2].tabIndex) {
                o = true;
                break;
              }
          ...
          return "bottom" === h2 && (o = o - e2.height + (this.options.coverTrigger ? t3.height : 0)), "right" === d && (s2 = s2 - e2.width + t3.width), { x: s2, y: o, verticalAlignment: h2, horizontalAlignment: d, height: i, width: n2 };
          ...
          s.remove(this.dropdownEl), s({ targets: this.dropdownEl, opacity: { value: 0, easing: "easeOutQuint" }, scaleX: 0.3, scaleY: 0.3, duration: this.options.outDuration, easing: "easeOutQuint", complete: function(t3) {
            if (e2._resetDropdownStyles(), "function" == typeof e2.options.onCloseEnd) {
